...
<template>
  <div class="w-full max-w-2xl ml-auto mr-auto relative">
    <ButtonGroup class="ml-auto mr-auto sticky top-4 z-5 bg-white/80 backdrop-blur-lg rounded-[8px]">
      <Button class="bg-transparent" v-for="tab in tutorTabs" :key="tab.type" variant="outline"
